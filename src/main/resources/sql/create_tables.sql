...
CREATE TABLE referral_source (
	...
	CONSTRAINT PK_ReferralSource PRIMARY KEY NONCLUSTERED (id),
...
CREATE TABLE job_posting (
	...
	required_tech VARCHAR(MAX), -- will come as a comma delimited string from Java
	preferred_tech VARCHAR(MAX), -- will come as a comma delimited string from Java
	referral_source_id BIGINT,
	[VERSION] BIGINT,

	CONSTRAINT PK_JobPosting PRIMARY KEY NONCLUSTERED (id),
...
CREATE TABLE job_application (
	...
	CONSTRAINT PK_JobApplication PRIMARY KEY NONCLUSTERED (id),
...
CREATE TABLE application_status (
	...
	CONSTRAINT PK_ApplicationStatus PRIMARY KEY NONCLUSTERED (id),
...
CREATE TABLE interview (
	...
	CONSTRAINT PK_Interview PRIMARY KEY NONCLUSTERED (id),
